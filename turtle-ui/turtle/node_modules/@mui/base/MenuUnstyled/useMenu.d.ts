import { MenuItemMetadata, MenuItemState, UseMenuListboxSlotProps, UseMenuParameters } from '@mui/base/MenuUnstyled/useMenu.types';
...
export default function useMenu(parameters?: UseMenuParameters): {
    ...
    getItemProps: <TOther_1 extends EventHandlers = {}>(option: string, otherHandlers?: TOther_1) => import("@mui/base/ListboxUnstyled").UseListboxOptionSlotProps<TOther_1>;
