...
import { MergeSlotPropsParameters, WithRef } from '@mui/base/utils/mergeSlotProps';
 ...
 */
export default function useSlotProps<SlotProps, ExternalForwardedProps, ExternalSlotProps, AdditionalProps, OwnerState>(parameters: UseSlotPropsParameters<SlotProps, ExternalForwardedProps, WithRef<ExternalSlotProps>, WithRef<AdditionalProps>, OwnerState>): import("@mui/types").Simplify<SlotProps & import("@mui/base/utils/omitEventHandlers").OmitEventHandlers<Record<string, unknown>> & import("@mui/base/utils/omitEventHandlers").OmitEventHandlers<WithRef<ExternalSlotProps>> & AdditionalProps & {
